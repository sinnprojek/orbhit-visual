...
export default function GallerySection() {
    ...
    useEffect(() => {
        const fetchLatest = async () => {
            try {
                // ✅ Pakai api.js (tidak pakai fetch langsung)
                ...
                if (Array.isArray(data)) {
                    const sorted = data
                        .sort(
                            (a, b) =>
                                new Date(b.eventDate || b._id) -
                                new Date(a.eventDate || a._id)
                        )
                        .slice(0, 6);
    ...
    if (loading) {
        return (
            <section className="max-w-6xl mx-auto py-20 px-6 text-center text-gray-400">
                Loading karya terbaru...
            </section>
        );
    }
